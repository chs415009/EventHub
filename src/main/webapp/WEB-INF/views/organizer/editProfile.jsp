            ...
            <div class="col">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/organizer/profile">My Profile</a></li>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="${pageContext.request.contextPath}/organizer/profile/edit" method="post">
                            <input type="hidden" name="id" value="${organizer.id}" />
                            
                            <div class="mb-3">
                                <label for="username" class="form-label">Username</label>
                                <input type="text" class="form-control" id="username" name="username" value="${organizer.username}" readonly>
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a href="${pageContext.request.contextPath}/organizer/profile" class="btn btn-secondary me-md-2">Cancel</a>
