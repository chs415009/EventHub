        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form:form action="${pageContext.request.contextPath}/organizer/events/edit/${event.id}" method="post" modelAttribute="event">
                            <form:hidden path="id" />
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">Current registrations: ${event.registeredCustomers.size()}</div>
