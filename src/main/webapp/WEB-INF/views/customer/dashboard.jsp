    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" href="${pageContext.request.contextPath}/customer/dashboard">Dashboard</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-4">
                                ...
                                <div class="card mb-3">
                                    <div class="card-body text-center">
                                        ...
                                        <div class="d-grid gap-2">
                                            <a href="${pageContext.request.contextPath}/customer/events" class="btn btn-outline-info">Browse Events</a>
                                            <a href="${pageContext.request.contextPath}/customer/registrations" class="btn btn-outline-info">My Registrations</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-info text-white">
                        <h5 class="mb-0">Past Events You've Attended</h5>
                    </div>
                    <div class="card-body">
