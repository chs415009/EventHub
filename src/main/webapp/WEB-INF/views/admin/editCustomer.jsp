...
<head>
    ...
    <title>Edit Customer - EventHub Admin</title>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="${pageContext.request.contextPath}/admin/customers/edit/${customer.id}" method="post">
                            <div class="mb-3">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a href="${pageContext.request.contextPath}/admin/customers" class="btn btn-secondary me-md-2">Cancel</a>
